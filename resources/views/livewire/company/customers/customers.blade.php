<div>
    <div class="relative mb-6 w-full">
        <flux:heading level="1" size="xl">Customers</flux:heading>
        <flux:subheading size="xl" class="mb-6">Manange Your All Customers</flux:subheading>
        <flux:separator variant="subtle" />
    </div>

    <div class="flex md:flex-row flex-col justify-between mb-5 gap-4">
        <flux:button 
            :href="route('master-data.customer.create')" icon:trailing="plus-circle">
            Create
        </flux:button>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <div wire:ignore class="flex items-center gap-3">
                                <flux:button size="sm" :href="route('master-data.customer.edit', $customer->uuid)" variant="ghost" class="cursor-pointer">Edit</flux:button>
                                <flux:button size="sm" variant="danger" class="cursor-pointer" wire:click="delete({{ $customer->id }})">Delete</flux:button>
                            </div>
                        </td>
                    </tr>
                @empty
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                        <td colspan="4" class="text-center text-gray-900 dark:text-white py-5">No Record Found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <livewire:company.customers.customer-delete />
</div>
