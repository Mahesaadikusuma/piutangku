<div>
    <div class="relative mb-6 w-full">
        <flux:heading level="1" size="xl">Daftar Hutang</flux:heading>
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                @endif
                                <flux:button size="sm" icon='eye' variant="filled" :href="route('transactions.piutang.customer.detail', $piutang->uuid)" class="cursor-pointer">Detail</flux:button>
