                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4 ">
                            <div class="flex items-center gap-3">
                                <flux:button size="sm" icon='arrow-down-tray' wire:click='downloadPdfById({{ $transaction->id }})' variant="ghost" class="cursor-pointer">Pdf</flux:button>
                                @if ($transaction->status == App\Enums\StatusType::PENDING->value)
                                <flux:button size="sm" icon='shopping-cart' variant="primary" class="cursor-pointer" :href="route('transactions.customer.trnsaction.payment', $transaction->uuid)">
                                    Payment
                                </flux:button>
                                @endif
                                <flux:button :href="route('transactions.customer.trnsaction.detail',$transaction->uuid)" variant="filled">
                                    Detail
                                </flux:button>
                            </div>
                        </td>
